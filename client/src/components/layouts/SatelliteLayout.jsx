  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex flex-1">
        {/* Mobile header */}
        <div className="lg:hidden fixed top-[42px] left-0 right-0 bg-primary-700 text-white p-4 flex items-center justify-between z-30">
        ...
        <aside className={clsx(
          "fixed top-[42px] left-0 h-[calc(100vh-42px)] w-64 bg-primary-800 text-white z-50 transform transition-transform duration-200",
          "lg:translate-x-0",
          ...
          <div className="p-4 flex items-center justify-between border-b border-primary-700">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold">Satellitare</span>
            </div>
        ...
        {/* Main content */}
        <main className="lg:ml-64 flex-1 mt-0 lg:mt-0 pt-[60px] lg:pt-0">
          <Outlet />
        </main>
      </div>
